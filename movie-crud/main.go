...
// deletes movie to be updated and add the movie with the new details
...
func main() {
	...
	movies = append(movies, Movie{ID: "1", Isbn: "123456", Title: "Imagine", Director: &Director{Firstname: "Victor", Lastname: "Efedi"}})
